...
<%
    ...
    if(request.getAttribute("error")!=null) {
        if (request.getAttribute("error").equals("xác nhận mật khẩu không khớp")) {
            error = "xác nhận mật khẩu không khớp";
        } else if (request.getAttribute("error").equals("username đã tồn tại")) {
            error = "username đã tồn tại";
        } else if (request.getAttribute("error").equals("email đã được đăng kí")) {
...
<form action="do-Register" method="post">
  ...
  <label id="error" name="error"><%=error%></label>
    <script>
        messageError = document.getElementById("error");
        if(messageError=="xác nhận mật khẩu không khớp"){
            window.alert("xác nhận mật khẩu không khớp");
        }else if(messageError=="username đã tồn tại"){
            window.alert("username đã tồn tại")
        }else if(messageError=="email đã được đăng kí"){
