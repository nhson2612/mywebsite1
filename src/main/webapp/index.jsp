    ...
    <div class="col-sm-6 col-md-4">
        <div class="card" style="width: 18rem;">
            <ul class="list-group list-group-flush">
                <li class="list-group-item">Bán chạy</li>
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="1.png" class="d-block w-100" alt="..." height="300" width="400">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="2.png" class="d-block w-100" alt="..." height="300" width="400">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="3.png" class="d-block w-100" alt="..." height="300" width="400">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
            </div>
